    ...
    <div className="bg-[#ffe8a2]">
      ...
      <div className="min-h-screen flex justify-center items-center bg-[#ffe8a2] px-4">
        ...
        <Modal
          ...
          className="react-modal-content max-w-md w-full p-6 rounded-lg bg-white shadow-lg"
          overlayClassName="react-modal-overlay bg-black bg-opacity-50"
        >
          <h2 className="text-2xl font-bold mb-4 text-[#313B2F]">Contact Me</h2>
